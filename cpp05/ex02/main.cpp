...
int main() {
	...
	try {
		...
		// Create a bureaucrat with a grade that can execute the form
		Bureaucrat executor("Alice", 1); // Adjust the grade as needed
		std::cout << "Created bureaucrat: " << executor.getName() << ", Grade: " << static_cast<int>(executor.getGrade()) << std::endl;

		// Create a PresidentialPardonForm
		PresidentialPardonForm PresidentialFrom("target");
		std::cout << "Created PresidentialPardonForm for: " << PresidentialFrom.getAFormName() << std::endl;
		std::cout << "Grade to sign : " << static_cast<int>(PresidentialFrom.getGradeToSign()) << std::endl;
		std::cout << "Grade to execute : " << static_cast<int>(PresidentialFrom.getGradeToexec()) << std::endl;

		// Attempt to sign the form
		std::cout << "Signing the form..." << std::endl;
		signer.signAForm(PresidentialFrom);
